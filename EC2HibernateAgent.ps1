        ...
        if ($runLoop) {
            ...
            while ($true) {
                ...
                try {
                    ...
                    Write-EventLog –LogName Application –Source $eventLogSource –EntryType Information –EventID 15 –Message "Sending IMDS_V2 to get Hibernate-Option.Configured meta-data" -ErrorAction SilentlyContinue
                    ...
                    Write-EventLog –LogName Application –Source $eventLogSource –EntryType Information –EventID 16 –Message "Failed to get Hibernate-Option.Configured meta-data" -ErrorAction SilentlyContinue
                    $hibernateConfigured = $null;
                }

                if (($hibernateConfigured) -and ($hibernateConfigured -match $true)) {
                    Write-EventLog –LogName Application –Source $eventLogSource –EntryType Information –EventID 17 –Message "Hibernation-option.Configured = true. Existing Spot Window Agent" -ErrorAction SilentlyContinue
